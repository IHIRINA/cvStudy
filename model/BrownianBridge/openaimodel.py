...
class UNetModel(nn.Module):
    ...
    def forward(self, x, time_emb=None, timesteps=None, context=None, y=None,**kwargs):
        """
        ...
        # context = th.cat([context, y], dim=1)
